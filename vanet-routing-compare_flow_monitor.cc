...
VanetRoutingExperiment::Run ()
{
  ...
  AnimationInterface anim("dsrc_sim1.xml");// For NetAnim
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  Ptr<Ipv4FlowClassifier> classifier = DynamicCast<Ivp4FlowClassifier> (flowmon.GetClassifier ());
...
Sent Packets = Sent Packets + (iter->second.txPackets);
Received Packets = Received Packets + (iter->second.rxPackets);
Lost Packets = Lost Packets + (iter->second.txPackets-iter->second.rxPackets);
...
monitor->SerializeToXmlFile("dsrc_sim1_performance.flowmon", true, true);
